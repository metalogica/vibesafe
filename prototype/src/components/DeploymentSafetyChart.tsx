        ...
        <div>
          ...
          {status === 'idle' ? (
            <div className="flex items-baseline gap-3">
              <span className="text-4xl font-display font-bold text-[#8FA3B8]/30 tracking-tight">
                --%
              </span>
              <span className="text-sm font-medium text-[#8FA3B8]/50 uppercase tracking-widest">
                Waiting for input...
              </span>
            </div>
          ) : (
        ...
        {status === 'idle' && (
          <div className="absolute inset-0 flex items-center justify-center z-10">
            <div className="text-center">
              <p className="text-[#E6EEF8] font-medium text-lg mb-1">No data, no drama.</p>
              <p className="text-[#8FA3B8] text-sm">Start an audit to see the chaos unfold.</p>
            </div>
          </div>
        )}
