...
import { Sparkles, ArrowRight, Flame, Search, CheckCircle2, AlertTriangle, Terminal, Bot, Shield, Zap } from 'lucide-react';

interface LandingPageProps {
  onRoast: (url: string) => void;
}

export const LandingPage: React.FC<LandingPageProps> = ({ onRoast }) => {
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="flex justify-center lg:justify-end animate-in fade-in slide-in-from-right-8 duration-1000 delay-200">
            <div className="relative w-full max-w-[500px] aspect-square">
              ...
              <img 
                src="https://res.cloudinary.com/dk9mn4cvz/image/upload/v1771718640/Roastybara-Character-Hero-transparent_nrn6sj.png" 
                alt="Roastybara Hero" 
                ...
                onError={(e) => {
                  // Fallback if the specific image fails (since I can't guarantee the URL validity of the user's upload in this context)
                  // Using a placeholder capybara image
                  e.currentTarget.src = "https://images.unsplash.com/photo-1605092676920-196d84924b20?q=80&w=1000&auto=format&fit=crop";
                }}
              />
            </div>
          </div>
      ...
      <section className="py-24 bg-[#0F1620]/50 border-y border-[#1C2430]">
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl md:text-4xl font-display font-bold mb-4">Roast → Fix → LGTM</h2>
